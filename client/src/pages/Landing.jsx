  ...
  return (
    <div style={{ position: 'relative', minHeight: '100vh', background: bg, fontFamily: "'Inter',system-ui,sans-serif", color: tc, transition: 'background 0.3s, color 0.3s' }}>
      ...
      <style>{`
        ...
        @keyframes loadingEntrance{0%{opacity:0;transform:scale(.04)}18%{opacity:1;transform:scale(.04)}42%{opacity:1;transform:scale(1)}62%{opacity:1;transform:scale(1)}84%{opacity:.9;transform:scale(8)}100%{opacity:0;transform:scale(28)}}
